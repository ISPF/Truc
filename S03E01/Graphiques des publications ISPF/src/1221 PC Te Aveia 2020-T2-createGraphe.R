...
graphe1 <- melt(graphe1,id.vars="Variation")
graphe1[, Variation:=factor(Variation, levels=c("Variation Avril/n-1","Variation Mai/n-1","Variation Juin/n-1"))]
graphe1[,variable:=stringr::str_wrap(variable, 25)]

g1 <- ggplot(graphe1, aes(x=variable, y=value, color=Variation, fill=Variation)) +
